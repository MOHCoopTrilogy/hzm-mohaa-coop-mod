...
//
// THE SURF ZONE'S MOVING CREST. models/fx/coop_surf.tik floats 5 u above the painted shore water
...
coop_surf_bore
{
	...
	deformVertexes wave 989.9 inversesawtooth 0 20.0 0 0.16		// bore: lambda 700 u = 17.8 m, T 6.2 s, 112 u/s up the beach
